...
# Customer Class
class Customer:
    def __init__(self, first_name, last_name, nationality, date_of_birth, email, address):   #Here I Intilized the customer attributes
    ...
    def setFirstName(self, first_name):   #Here I Wrote the set and get methods for each attribute
        self.first_name = first_name
    ...
    def displayCustomerInfo(self):    #Here I displayed the customer attributes
    ...
    def customerPurchaseHistory(self):   #Here I created the purchase history function
...
# Manager Class
class Manager:
    def __init__(self, first_name, last_name, nationality, date_of_birth, responsibility, salary): #Here I intilized the Manager attributes
        self.first_name = first_name
        self.last_name = last_name
        self.nationality = nationality
        self.date_of_birth = date_of_birth
    ...
    def displayManagerInfo(self):    #Here I displayed the Manager Information
    ...
    def managerProgress(self): #Here I created the manager rogress function
...
class DeliveryStaff:
    def __init__(self, first_name, last_name, nationality, date_of_birth, orders_number, shifts):  #Here I Intilized the Delivery staff attributes
        self.first_name = first_name
        self.last_name = last_name
        self.nationality = nationality
        self.date_of_birth = date_of_birth
    ...
    def setFirstName(self, first_name):   #Here I wrote the set and methods for each attributes
        self.first_name = first_name
    ...
    def displayDeliveryStaff(self):    #Here I display the delivery staff details
    ...
    def deliveryProgress(self):    # Here I created the delivery progress function
...
# Deliver Order Class
class DeliverOrder:
    def __init__(self, orderID, status, total_amount, delivery_time, delivery_address):  #Here I intlized the delivery order attributes
    ...
    def setOrderID(self, orderID):   #Here I wrote the set and get methods for each attribute
        self.orderID = orderID
    ...
    def displayOrderInfo(self):   #Here I displayed the order information
    ...
    def calculateTotal(self):   #Here I created the calculate total function
